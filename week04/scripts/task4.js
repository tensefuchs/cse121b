...
myInfo.name = "Tense Fuchs";

// Step 3: Add another property named photo with a value of the image path and name (used in Task 2) as a string
myInfo.photo = "../week02/images/gab-yan.jpg";

// Step 4: Add another property named favoriteFoods with a value of an array of your favorite foods as strings ( hint: [] )
myInfo.favoriteFoods = ["Tom Kha Gai", "Ramen", "Tofu"];

// Step 5: Add another property named hobbies with a value of an array of your hobbies as strings
myInfo.hobbies = ["Hiking", "Chess", "Playing the piano"];
...
myInfo.placesLived[0].place = "Zurich, Switzerland";
myInfo.placesLived[0].length = "1 years";

// Step 9: Add additional objects with the same properties for each place you've lived
myInfo.placesLived.push({ place: "Bangkok, Thailand", length: "15 years" });
myInfo.placesLived.push({ place: "Melbourn, Australia", length: "2 years" });
myInfo.placesLived.push({ place: "California, United States", length: "3 years" });
